...
public class TotalContent {
	...
	public String toString() {
		return "TotalContent [email=" + email + ", image_num=" + image_num
				+ ", physical_name=" + physical_name + ", image_name="
				+ image_name + ", imagefile=" + Arrays.toString(imagefile)
				+ ", favorite=" + favorite + ", image_date=" + image_date
				+ ", imgbtnVal=" + imgbtnVal + ", article_num=" + article_num
				+ ", scrab_num=" + scrab_num + ", name=" + name + ", content="
				+ content + ", article_date=" + article_date + ", category="
				+ category + ", scrabPrivate=" + scrabPrivate
				+ ", articlebtnVal=" + articlebtnVal + "]";
	}
