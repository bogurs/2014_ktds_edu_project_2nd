...
public class SearchVO {
	...
	public String toString() {
		return "SearchVO [email=" + email + ", article_num=" + article_num
				+ ", searchOption=" + searchOption + ", searchContent="
				+ searchContent + ", searchCategory=" + searchCategory
				+ ", searchGender=" + searchGender + ", searchAge=" + searchAge
				+ "]";
	}
