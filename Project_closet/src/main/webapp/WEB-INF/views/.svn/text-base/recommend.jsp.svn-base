...
<body background="/closet/resources/img/main.jpg">
	...
	<div id="main_section">
	<ul id="tabs">
	    <li><a href="#"  onclick="tagReq('${email}')" title="동일한 태그를 갖는 게시글을 볼 수 있습니다.">태그(${tagReqCount})</a></li>
	    <li><a href="#"  onclick="brandReq('${email}')" title="동일한 브랜드 아이템을 갖는 게시글을 볼 수 있습니다.">브랜드(${brandReqCount})</a></li>    
	</ul>
