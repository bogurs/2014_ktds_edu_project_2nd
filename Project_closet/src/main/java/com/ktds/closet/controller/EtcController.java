...
//			etcService.deletefriend(req.getParameter("seqno"));			
		...
		public String updateprofile(HttpServletRequest req,MultipartHttpServletRequest mreq, String cm,String kg, String status){
			mav =new ModelAndView();
			String myemail=(String)req.getSession().getAttribute("email");
		...
		public ModelAndView profileImageDown(String email,HttpServletRequest req){
				...
				if(image==null) image=etcService.profileImageDown("manager@manager.com");
		...
		public ModelAndView closet(String email, HttpServletRequest req){
			...
			if(!myemail.equals(email)){
				...
				if(fdemail==null) fdemail="";
				if(fdemail.equals(email)) statusnum=1;
				else statusnum=2;
