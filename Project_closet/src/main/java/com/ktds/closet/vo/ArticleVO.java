...
public class ArticleVO {
	...
	public String toString() {
		return "ArticleVO [article_num=" + article_num + ", scrab_num=" + scrab_num + ", email=" + email + ", name="
				+ name + ", content=" + content + ", favorite=" + favorite + ", article_date=" + article_date
				+ ", category=" + category + ", scrabPrivate=" + scrabPrivate + ", tag=" + tag + ", tab=" + tab
				+ ", gender=" + gender + ", btnVal=" + btnVal + "]";
	}
