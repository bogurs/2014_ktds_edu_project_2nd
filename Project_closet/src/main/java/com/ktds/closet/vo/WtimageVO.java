...
public class WtimageVO {
	...
	public String toString() {
		return "WtimageVO [email=" + email + ", wtimage_num=" + wtimage_num
				+ ", wtphysical_name=" + wtphysical_name + ", wtimage_name="
				+ wtimage_name + ", wtimagefile="
				+ Arrays.toString(wtimagefile) + ", wtfavorite=" + wtfavorite
				+ ", wtimage_date=" + wtimage_date + ", article_num="
				+ article_num + "]";
	}
