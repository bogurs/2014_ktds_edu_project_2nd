...
public class ImageVO {
	...
	public String toString() {
		return "ImageVO [image_num=" + image_num + ", physical_name=" + physical_name + ", image_name=" + image_name
				+ ", imagefile=" + Arrays.toString(imagefile) + ", favorite=" + favorite + ", image_date=" + image_date
